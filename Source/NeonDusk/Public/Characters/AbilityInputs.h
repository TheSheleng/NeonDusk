...
struct NEONDUSK_API FMoverExampleAbilityInputs : public FMoverDataStructBase
{
...
UCLASS()
class NEONDUSK_API UMoverExampleAbilityInputsLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
