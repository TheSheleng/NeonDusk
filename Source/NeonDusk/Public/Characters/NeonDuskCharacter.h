...
#include "NeonDuskCharacter.generated.h"
...
UCLASS(Abstract)
class NEONDUSK_API ANeonDuskCharacter : public APawn, public IMoverInputProducerInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this pawn's properties
	ANeonDuskCharacter(const FObjectInitializer& ObjectInitializer);
